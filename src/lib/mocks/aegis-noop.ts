 ...
 * `import('@hanview/aegis-enterprise')` references when the optional
 * SDK is not installed (default in this repository). Constructors throw
 * so runtime callers fall back to their own degraded paths.
 */
