...
describe('Logger', () => {
    ...
    describe('debug()', () => {
        it('should log with multiple arguments', () => {
            ...
            expect(consoleState.mocks.log).toHaveBeenCalledWith(
                '[DEBUG]',
                'test',
                123,
                { foo: 'bar' }
    ...
    describe('warn()', () => {
        it('should log warning messages', () => {
            ...
            expect(consoleState.mocks.warn).toHaveBeenCalledWith(
                '[WARN]',
                'Warning message'
            );
        });
    ...
    describe('error()', () => {
        it('should log error messages', () => {
            ...
            expect(consoleState.mocks.error).toHaveBeenCalledWith(
                '[ERROR]',
                'Error message'
            );
        });
    ...
    describe('Additional Methods', () => {
        ...
        it('should call assert()', () => {
            ...
            expect(consoleState.mocks.assert).toHaveBeenCalledWith(
                false,
                '[ASSERT]',
                'assertion failed'
            );
