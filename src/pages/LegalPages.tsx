...
const PAGES: Record<string, { title: string; updated: string; sections: Array<{ heading: string; body: string }> }> = {
  ...
  privacy: {
    ...
    sections: [
      ...
      { heading: '6. 정보주체의 권리·의무', body: '이용자는 언제든지 다음의 권리를 행사할 수 있습니다:\n- 개인정보 열람 요구\n- 오류 등이 있을 경우 정정 요구\n- 삭제 요구\n- 처리정지 요구\n위 권리 행사는 회사에 대해 서면, 전자우편(ray.kim@yatavent.com)을 통하여 하실 수 있으며, 회사는 이에 대해 지체없이 조치하겠습니다.' },
  ...
  refund: {
    ...
    sections: [
      ...
      { heading: '문의', body: '환불 관련 문의: ray.kim@yatavent.com\n응답 시간: 영업일 기준 24시간 이내' },
    ],
  },
};
