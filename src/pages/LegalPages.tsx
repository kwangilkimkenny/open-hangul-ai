...
> = {
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        body: '이용계약은 이용자가 약관의 내용에 대하여 동의를 한 후 회원가입신청을 하고 회사가 이러한 신청에 대하여 승낙함으로써 체결됩니다.',
      },
      {
        heading: '제6조 (회원의 의무)',
      ...
      {
        heading: '제9조 (분쟁해결)',
        body: '본 약관과 관련하여 발생한 분쟁에 대해서는 대한민국 법을 준거법으로 하며, 서울중앙지방법원을 제1심 관할법원으로 합니다.',
      },
    ],
  },
  privacy: {
  ...
  refund: {
    ...
    sections: [
      {
        heading: '1. 환불 원칙',
        body: '회사는 「전자상거래 등에서의 소비자보호에 관한 법률」 및 관련 법령에 따라 이용자의 환불 요청을 처리합니다.',
      },
      {
        heading: '2. 청약철회 (전액 환불)',
        body: '유료 플랜 결제 후 7일 이내, 서비스를 사용하지 않은 경우 100% 전액 환불됩니다.\n청약철회는 마이페이지 또는 yatav@yatavent.com으로 요청 가능합니다.',
      },
      {
        heading: '3. 일부 사용 후 환불',
        body: '월간 플랜: 결제 후 7일 이내 사용했더라도 사용량에 비례하여 일할 환불\n연간 플랜: 사용한 월수에 대해 월 정상가 기준으로 차감 후 잔액 환불\n예시: 연 99,000원 결제 후 3개월 사용 → 99,000 - (9,900 × 3) = 69,300원 환불',
      },
      {
        heading: '4. 환불 불가 사유',
        body: '다음의 경우 환불이 제한됩니다:\n- 결제 후 30일이 경과한 경우 (월간 플랜)\n- 약관 위반으로 서비스가 중지된 경우\n- 무료 플랜에서 발생한 사용 (환불할 금액 없음)\n- AI 크레딧을 80% 이상 소진한 경우',
      },
      {
        heading: '5. 환불 절차 및 처리 기간',
        body: '1. 마이페이지 > 결제 내역 > 환불 요청 클릭\n2. 환불 사유 입력 후 제출\n3. 영업일 기준 3-5일 내 검토\n4. 승인 시 결제 수단에 따라 7-14일 내 환불 처리\n   - 신용카드: 결제 취소 (카드사 정책에 따라 최대 1개월 소요)\n   - 계좌이체: 입금 계좌로 송금\n   - 카카오페이/토스페이: 결제 수단으로 즉시 환불',
      },
      {
        heading: '6. 자동 결제 해지',
        body: '정기 결제 해지는 마이페이지 > 구독 관리에서 언제든지 가능합니다.\n해지 후에도 현재 결제 주기 종료일까지는 서비스를 이용할 수 있습니다.\n해지 후 환불은 위 "일부 사용 후 환불" 정책을 따릅니다.',
      },
      {
        heading: '7. 분쟁 해결',
        body: '환불 관련 분쟁이 발생할 경우 다음 기관을 통해 조정을 신청할 수 있습니다:\n- 한국소비자원: www.kca.go.kr / 1372\n- 전자거래분쟁조정위원회: www.ecmc.or.kr\n- 공정거래위원회: www.ftc.go.kr',
      },
      {
        heading: '문의',
        body: '환불 관련 문의: yatav@yatavent.com\n응답 시간: 영업일 기준 24시간 이내',
      },
    ],
  },
};
