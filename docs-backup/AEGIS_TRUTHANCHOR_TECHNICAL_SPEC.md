...
OpenHangul AI 에디터는 **AEGIS**(AI 보안)와 **TruthAnchor**(할루시네이션 검증)
두 시스템을 통합하여, 사용자가 참조 문서를 기반으로 AI 콘텐츠를 생성할 때
**입출력 보안**과 **사실 정확성**을 동시에 보장합니다.
...
- 영어: increased by, decreased by, rose by, fell by, growth of, gain of,
  rising, declining
...
- 보고기간: 보고, 통계, 기준, 월중, 분기 / report, data, statistics, fiscal,
  period
